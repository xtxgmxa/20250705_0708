          ...
          },
          {
            ...
            activities: [
              ...
              },
              {
                ...
                location: "搭地鐵至「若從<a href='https://maps.app.goo.gl/qLG7UArHd3RcLjN56'>沙田站</a> → <a href='https://maps.app.goo.gl/Qt4PXt8XHEck82e79'>尖沙咀站 → 星光大道</a>」",
                duration: "車程約 35 分鐘",
                icon: "fas fa-star",
                notes: "建議吃晚餐→海邊散步看燈光秀(<a href='https://www.klook.com/zh-TW/destination/p50134477-avenue-of-stars/2-food-and-dining/'>星光大道附近晚餐推薦</a>)",
              },
              {
                time: "20:00",
                timeObj: { hour: 20, minute: 0 },
                title: "<a href='https://maps.app.goo.gl/cfv68KeSHZva1ytEA'>幻彩詠香江燈光秀</a>",
                location: "維港海濱（免費）",
                duration: "約 10～15 分鐘",
                icon: "fas fa-lightbulb",
                notes: "表演時間：每晚20:00，長度約10分鐘",
              },
              {
                time: "21:00",
          ...
          },
          {
            ...
            activities: [
              ...
              },
              {
                ...
                duration: "玩 6～8 個設施",
                icon: "fas fa-magic",
                notes: "【推薦】<br /><strong>魔雪奇幻之旅：</strong>室內小船緩緩前進，音樂與動畫場景超夢幻<br /><strong>小小世界：</strong>室內水道小船遊，全程輕鬆<br /><strong>奇妙夢想城堡舞台表演：</strong>不用排隊，家長可自選位置拍照攝影<br /><strong>迷離莊園：</strong>刺激度低，是觀賞型室內小車。音樂與動畫很豐富，小朋友通常不害怕。<br /><strong>反斗奇兵大本營：</strong>視覺壯觀，但上下起伏溫和<br /><strong>沖天遙控車、轉轉彈弓狗：</strong>雖然是家庭向，但可能稍超出不刺激的範圍，可視小孩接受度。<br /><strong>探險世界：</strong>森林河流之旅坐船看動物模型、假景特效，不刺激、適合拍攝<br /><strong>泰山樹屋：</strong>爬樹屋可邊走邊拍，風景不錯<br><strong>蟻俠與黃蜂女-擊戰特攻：</strong>室內大型動態射擊型遊樂，一邊看著畫面和燈光互動",
              },
              {
                time: "17:00～18:30",
              ...
              },
              {
                ...
                timeObj: { hour: 20, minute: 0 },
                title: "回飯店休息",
                location: "<a href='https://maps.app.goo.gl/BiLKLUamt8eHF2faA'>迪士尼站</a> → <a href='https://maps.app.goo.gl/nmzgaobZabDeWc666'>沙田站</a>或叫UBER回麗豪酒店<br />(香港沙田大涌橋路34-36號)",
                duration: "約 1 小時",
                icon: "fas fa-subway",
                notes: "可沿途休息坐著睡覺",
              },
